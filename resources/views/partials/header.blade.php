...
<header class="w-full text-white" x-data="{ open: false }">
  <div class="bg-[#636CCB] relative z-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 flex flex-col lg:flex-row justify-between items-center gap-4 py-3">
      ...
      <div class="hidden lg:block text-sm w-full">
        <div class="bg-[#6E8CFB] p-5 rounded-lg">
          <div class="flex flex-col sm:flex-row justify-between items-center gap-3">
            <div class="relative h-6 overflow-hidden w-1/2">
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex gap-2 text-lg">
                <a href="#" class="hover:text-gray-200"><i class="fa-brands fa-square-facebook"></i></a>
                <a href="#" class="hover:text-gray-200"><i class="fa-brands fa-square-instagram"></i></a>
                <a href="#" class="hover:text-gray-200"><i class="fa-brands fa-square-youtube"></i></a>
                <a href="#" class="hover:text-gray-200"><i class="fa-brands fa-tiktok"></i></a>
              </div>
            </div>
          </div>
        </div>

        <div class="flex flex-wrap gap-8 py-5 justify-between">
          <div class="flex items-center gap-4">
            <i class="far fa-envelope text-yellow-500 text-xl"></i>
            <div>
              <p class="text-gray-400">Kirim Pesan</p>
              <p class="font-semibold">info@nagaraacbatang.com</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              <p class="text-gray-400">Chat & Call Us 24/7</p>
              <p class="font-semibold">(+62) 813-2871-5078</p>
            </div>
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="font-semibold">Sen-Min: 08.00-17.00</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
      <div class="flex justify-between items-center">
        <ul class="flex gap-8 py-6 uppercase tracking-wide text-sm font-semibold text-white">
          ...
          <li><a href="#" class="hover:text-yellow-500">Testimoni</a></li>
  ...
  >
    ...
    >
      <button @click="open = false" class="self-end text-white text-2xl">
        <flux:icon.x-mark />
      </button>
      <div class="flex flex-col gap-3">
        <span class="text-gray-300 font-semibold">Follow Us:</span>
        <div class="flex gap-3 text-lg">
          <a href="#" class="hover:text-yellow-500"><i class="fa-brands fa-square-facebook"></i></a>
          <a href="#" class="hover:text-yellow-500"><i class="fa-brands fa-square-instagram"></i></a>
          <a href="#" class="hover:text-yellow-500"><i class="fa-brands fa-square-youtube"></i></a>
          <a href="#" class="hover:text-yellow-500"><i class="fa-brands fa-tiktok"></i></a>
        </div>
      </div>
      ...
      <ul class="flex flex-col gap-4 uppercase font-semibold text-white">
        ...
        <li><a href="#" class="hover:text-yellow-500">Bengkel Kami</a></li>
        <li><a href="#" class="hover:text-yellow-500">Artikel</a></li>
        <li><a href="#" class="hover:text-yellow-500">Testimoni</a></li>
        <li><a href="#" class="hover:text-yellow-500">Kontak</a></li>
      </ul>

      <div class="flex items-center gap-2 text-yellow-500 mt-4">
        <flux:icon.map-pin />
        <span>Office Location</span>
      </div>
    </div>
